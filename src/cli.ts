...
function generateModelsFile(modelFiles: string[]) {
  ...
  return `// auto-generated by: by-zero generate\n${imports}\n\n${modelsObj}\n`
}
...
function generateTypesFile(modelFiles: string[]) {
  ...
  return `import type { TableInsertRow, TableUpdateRow } from 'by-zero'\nimport type * as schema from './tables'\n\n${typeExports}\n`
}
...
function generateGroupedQueriesFile(
  ...
  return `/**
 * auto-generated by: by-zero generate
 *
...
function generateSyncedQueriesFile(
  ...
  const imports = `// auto-generated by: by-zero generate
...
this folder is auto-generated by by-zero. do not edit files here directly.
...
see the [by-zero readme](./node_modules/by-zero/README.md) for full documentation.
`
}
